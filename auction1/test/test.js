...
contract('AuctionContract', function (accounts) {
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      /*<CODE HERE>*/ assert.notEqual(result, '0x0000000000000000000000000000000000000000', '')
      /**********
  ...
  it("revealwinners",function(){
    return auctionInstance.getPersonDetails(0,{from:accounts[1]})
    .then(function(result){
